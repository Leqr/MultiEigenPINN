...
class CustomLoss(torch.nn.Module):
    ...
    def forward(self, Ec, network, x_u_train, u_train, x_b_train, u_b_train, x_f_train, dataclass, verbose = False):
        ...
        res = Ec.compute_res(network, x_f_train, None, lambda_norm, lambda_orth,verbose).to(Ec.device)
